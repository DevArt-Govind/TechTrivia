...
@Component({
  selector: 'app-figma-quiz',
  templateUrl: './figma-quiz.component.html',
  styleUrl: './figma-quiz.component.scss'
})
export class FigmaQuizComponent {
  questions: any[] = [];
  ...
  ngOnInit(): void {
    this.http.get<any>('assets/quiz-data/figma-quiz.json').subscribe(data => {
